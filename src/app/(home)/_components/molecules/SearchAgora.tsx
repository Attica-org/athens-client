        ...
        <div className="flex-1 p-0.5rem pl-0">
          ...
          <div className="text-xs text-nowrap">
            ...
            <span className="dark:text-white dark:text-opacity-80">
              관찰자
              <span className="pl-3 text-athens-gray-thick dark:text-dark-line">10명</span>
            </span>
          </div>
        </div>
        <div className="relative">
          <UserImage className="w-67 h-67 bg-yellow-400 rounded-3xl" w={67} h={67} />
          <span className="absolute top-0 left-53 inline-block w-13 h-13 bg-red-400 rounded-full ml-3" />
        </div>
      </div>
    </article>
  );
