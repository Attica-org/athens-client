...
export default function SearchAgora() {
  return (
    <article className="w-full flex pb-0.5rem pl-1rem pr-1rem justify-center items-center">
      <UserImage />
      <div className="flex-1 p-0.5rem">
        ...
        <div className="text-xs text-nowrap">
          ...
          <span className="inline-block w-0.5rem h-0.5rem bg-red-400 rounded-full ml-3" />
        </div>
      </div>
    </article>
  );
